            ...
            <div className="border border-amber-800/10 p-4 h-full flex flex-col justify-between">
              ...
              <div className="flex justify-between items-end mt-6 pt-4 border-t border-amber-800/10">
                ...
                <div className="text-center space-y-1">
                  ...
                  <div className="w-16 h-6 border-b border-amber-800/20 border-dotted mx-auto flex items-center justify-center">
                    <span className="text-[10px] text-sky-600 font-serif italic">دکتر سهرابی</span>
                  </div>
                </div>
                ...
                <div className="text-center space-y-1">
                  ...
                  <div className="w-16 h-6 border-b border-amber-800/20 border-dotted mx-auto flex items-center justify-center">
                    <span className="text-[10px] text-indigo-600 font-serif italic">دکتر باقرزاده</span>
                  </div>
                </div>
